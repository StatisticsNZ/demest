...
```{r}
popn.true <- demdata::nz.popn.ta
dimnames(popn.true)$region <- paste("Region", 1:68)
...
dplot(~ year | age,
      ...
      overlay = list(values = subarray(popn.true, region == "Region 1" & sex == "Female"),
                     col = "red"))
```
