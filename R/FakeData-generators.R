...
##               if (has.exposure) {
##                   if (is.null(exposure))
##                       stop(gettextf("model includes %s term, but no '%s' argument supplied",
##                                     "exposure", "exposure"))
##               }
##               else {
##                   if (!is.null(exposure))
##                       stop(gettextf("model does not include %s term, but '%s' argument supplied",
##                                     "exposure", "exposure"))
##               }
##               if (!is.null(weights))
...
##               }
##               else
##                   log.theta <- stats::rnorm(n = n, mean = mu, sd = sigma)
##               theta <- exp(log.theta)
