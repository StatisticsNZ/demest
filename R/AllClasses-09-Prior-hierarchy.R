...
setClass("DLMWithTrendNormZeroNoSeason",
         prototype = prototype(iMethodPrior = 13L,
             ...
             ATau = methods::new("Scale", 1),
             nuTau = methods::new("DegreesFreedom", 7),
             GWithTrend = methods::new("DLMMatrix", matrix(c(1, 0, 1, 0.89), nrow = 2L, ncol = 2L)),
             WSqrt = methods::new("DLMMatrix", diag(2L)),
             WSqrtInvG = methods::new("DLMMatrix", matrix(c(1, 0, 1, 0.89), nrow = 2L, ncol = 2L))),
         contains = c("DLM",
             "NormMixin",
             "WithTrendMixin",
             "ZeroMixin"))
